...
const commentsControllers = {
    ...
    addComment: async (req, res) => {
        ...
        try {
            const nuevoComment = await Places.findOneAndUpdate({_id:place}, {$push: {comments: {comment: comment, userID: user}}}, {new: true}).populate("autor", {fullName:1}).populate("comments.userID", {fullName:1})
